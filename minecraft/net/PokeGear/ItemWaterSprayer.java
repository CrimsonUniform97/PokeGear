...
public class ItemWaterSprayer extends Item
{

public ItemWaterSprayer(int par1) 
{
		super(par1);		
...

{
   ...
   // {
        //if (par1ItemStack.isItemEqual(new ItemStack (modPokegear.ItemWaterSprayer.itemID)))
        {
